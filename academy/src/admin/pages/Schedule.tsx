          ...
          <div className="flex items-center gap-2.5 flex-wrap mb-1">
            ...
            {cohortVal && (
              <span
                ...
                style={{ background: COHORT_BADGE_BG[cohortVal] ?? '#f9f6ff', color: COHORT_BADGE_TEXT[cohortVal] ?? '#6B40A8' }}
              >
                {cohortVal}
              </span>
            )}
          ...
          {dayBlocks.map(b => (
            <div key={b.id} className="flex items-center gap-3 bg-white px-4 py-3" style={{ border: '1px solid #E3D9F7' }}>
              <span
                ...
                style={{ background: COHORT_BADGE_BG[b.cohort] ?? '#f9f6ff', color: COHORT_BADGE_TEXT[b.cohort] ?? '#6B40A8' }}
              >{b.cohort}</span>
